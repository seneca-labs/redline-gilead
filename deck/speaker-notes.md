# Redline · Gilead enterprise deck (gilead-v11) · 24 slides
...
## 6 · What Redline is
The whole product in one pipeline, four nodes left to right: the work goes in (an asset, its context, what the committee has said before); Redline prepares (builds the deck, checks it against your standards, stages every change); a person approves (a named sign-off, every time; Redline never submits on its own); the committee reviews (in Veeva, same tools, same routing as today). Node three is the does-the-AI-decide answer; read it slowly. Land the line: "Redline does the preparation. Your people make every decision." Falcon is deliberately NOT named on the slide. SPOKEN ONLY, and only if they raise Falcon or MLR tooling: "whatever your review runs on, including Falcon, Redline feeds it cleaner inputs. We're the other half, not a competitor."

## 7 · The seats it serves
Three seats, one pipeline. The spoken background, if the room wants it: CPC has run this for two-plus years; brands pushed into pilots to gauge efficiencies; submission work offshored to pods in Asia and India for cost and follow-the-sun coverage. NOT a new group. Get this right. Then the three cards left to right, each with what it does and what changes for it: the agency makes the work, Redline preps the submission around it in the agency's own workspace, and requirements now arrive up front, nothing guessed; the vendor pod runs the mechanics, packaging and submitting only what the agency signed off, and the work now arrives clean and staged, nothing to chase; Gilead holds the gate, the committee reviews in Veeva exactly as today, CPC sets the standards once for every agency, and it's one pipeline, on the record, the knowledge stays here. The dashed return line: standards and comments travel back the same way, into every workspace. Close on the handoff line: every handoff is finished work; nobody re-types anything. Mandate path if it comes up: corporate → brand team → that brand's agencies.

## 8 · The Gilead console
...
## 9 · A guided intake (arrow-keyed, 4 steps)
...
## 13 · Implement changes, with or without AI
...
## 17 · The committee's standards, encoded
...
## 18 · Integrated in what you already use
...
## 21 · How the AI stays honest (Trust 2)
...
## 22 · Where your data lives (Trust 3)

# Redline · Gilead enterprise deck (gilead-v1) · 28 slides
...
"[CRC — confirm exact name]" markers are deliberate. Say in the room: "we left your new group's name as a placeholder on purpose; tell us the right name and it's everywhere by tomorrow."
...
## 7 · Two views. One pipeline.
The centerpiece. Left, the agency workspace: their craft, their tools, their own isolated knowledge base. Right, the Gilead console: standards and visibility. The seam is the whole product: the submission flows right, the standard flows left. Say the isolation line exactly as written: agencies never see each other's work; Gilead sees all of it.

## 8 · A guided intake
Progressive disclosure: upload first, the system detects the format, one question at a time, prior answers collapse. The payoff is the requirements card: the confusing part of submitting, answered from Gilead's own history and standards before anything is built. This is what "fewer malformed submissions" looks like at the point of entry.
...
## 10 · Reads it the way the committee will
...
## 15 · Integrated in what you already use
...
## 19 · Built for the [CRC — confirm exact name]
The training-timing argument, verbatim: "You're standing up this group right now. Encode the standards while the process is being defined and every agency launches into the standardized workflow on day one. Retrofit it later and you're retraining every agency twice." Four bullets, read them all; the last one is the committee's favorite: fewer malformed submissions reaching them at all.
...
Four seats, quick pass: agencies own the craft, the committee owns the judgment, the [CRC] owns the standard, brand marketing owns the outcome. Same people, one way of working. Bridge into Trust: "now the questions your security team is already writing down."

## 22 · Where your data lives (Trust 1)
The perimeter diagram: your cloud, your tenant, your approved model endpoints. The TODO chip is deliberate — ask for the cloud and endpoint list in the room. Nothing leaves the perimeter, nothing trains a shared model, agencies are isolated, admins can inspect or delete anything.

## 23 · How the AI stays honest (Trust 2)
...
## 24 · AI is a dial, not a default (Trust 3)
...
## 25 · Rollout
Phase 1, weeks 1–8, implementation and calibration on live submissions, their team runs acceptance. Phase 2, the [CRC] standard goes live for the franchise. Phase 3, more franchises and agencies onto the same encoded standards. The walk-away strip is the summary of the whole deck — read it.

## 26 · What one submission costs today
Do not invent numbers. The ledger is time, the multiplier is theirs to fill in: [N] agencies, [M] submissions a year — get the volumes from Nikki and Matthew. Land the line as written: the platform costs less than the [CRC] will spend finding this out manually. If ROI math comes up, do it live on a whiteboard with their numbers.
...
## Open TODOs (brief §13)
- [CRC — confirm exact name] — everywhere the new group appears
- [TODO: confirm Gilead's cloud + approved AI endpoints] — Trust 1
- [TODO: portfolio volume numbers — get from Nikki/Matthew] — money slide [N] / [M]
- [Platform cost] — fill on the money slide landing line once the path is chosen
